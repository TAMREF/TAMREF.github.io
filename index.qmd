...
::: {.bio-links}
[Email](mailto:ckyun@umd.edu) · [GitHub](https://github.com/TAMREF)
:::
:::
...
::: {.news-list}
- [Sep 2026]{.news-date} *Optimal Learning-Augmented Algorithm for Online Bidding* is
  accepted to **NeurIPS 2026**.
- [Sep 2026]{.news-date} I joined the University of Maryland as a PhD student.
